...
if (isset($_GET['pesan'])) {
	...
	<script>
     ...
     window.setTimeout(function(){$(".alert-success").fadeTo(100,100).slideUp(500,function(){$(this).remove();});}, 6000);
     window.setTimeout(function(){$(".alert-info").fadeTo(100,100).slideUp(500,function(){$(this).remove();});}, 6000);
</script>
   </script>
...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100">
			<a href="halaman_masyarakat.php"><img src="images/lapor-tegalsari.png" width="85px"></a><br>
...
<br>
  ...
  <a href="profil.php?nik=<?php echo $datat['nik']; ?>"><i class="fa fa-user"></i><b> Profil</b></a>&nbsp;&nbsp;|&nbsp;
   <a href="datapengaduanmas.php?nik=<?php echo $datat['nik']; ?>"><i class="fa fa-file"></i><b> Riwayat Data</b></a>&nbsp;&nbsp;|
<!--    <a href="datatanggapan.php?nik=<?php echo $datat['nik'];  ?>"><b>Tanggapan</b></a>&nbsp; -->
...
<p style="text-align: center;">Halo <b><?php echo $_SESSION['username']; ?></b>, Anda Saat Ini dalam akun sebagai <b>Masyarakat</b>, Anda adalah warga <b>Tegalsari</b> yang akan mengirim pengaduan laporan kepada Pihak yang Berwenang</b></p>
</div>
...
<p align="center">
<img style="width:80px; height: 80px; border-radius: 50px ; " src="images/profil/<?php if($dat['foto'] == null){ echo 'default-image.jpg'; } else{echo $dat['foto'];}  ?>"><br>
...
<input class="form-control" type="hidden" name="tanggal" value="<?php echo $tgl ?>" required="">
