...
echo "<div class='alert-info text-center p-b-35'><b>Anda Sebagai Administrator Berhasil Memperbaharui Data !</b></div>";
 ...
 ?>
  ...
  <script>
	...
	<br><br><span class="text-center"><h2>Data Masyarakat</h2></span><br>
...
<tr>
	...
	<td>
		<img style="width: 80px; height: 80px;" src="images/profil/<?php if($data['foto'] == null){ echo 'default-image.jpg'; } else{echo $data['foto'];}  ?>">
	</td>
	<td>
		<a href="editmasyarakat.php?nik=<?php echo $data['nik']; ?>">
			<button class="btn btn-success">Edit</button>
		</a>
		 <a href="javascript:hapusdata(<?php echo $data['nik']; ?>)">
