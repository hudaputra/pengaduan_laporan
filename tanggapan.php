  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <a href="halaman_petugas.php"><img src="images/lapor-tegalsari3.png" width="225px"></a>

        <h2 align="center">Tanggapan</h2>
        ...
        while ($data = mysqli_fetch_array($query)) {   ?>
          ...
          while ($id = mysqli_fetch_array($idpet)) {   ?>
            ...
            <form action="kirimtanggapan.php" method="POST" class="form-group">
              ...
              <input type="hidden" name="nama" value="<?php echo $id['nama_petugas']; ?>">
            <?php } ?>
            <input type="hidden" name="id_pengaduan" value="<?php echo $data['id_pengaduan'] ?>">
            <input type="hidden" name="tanggal" value="<?php echo $tgl ?>">
            <div class="form-group">
              <label>Berikan Tanggapan</label>
              <textarea class="form-control" name="tanggapan" rows="10" placeholder="Berikan tanggapan anda disini .."></textarea>
            </div>
