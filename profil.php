...
<span class="login100-form-title p-b-48">
			<a href="halaman_masyarakat.php"><img src="images/lapor-tegalsari.png" width="35%"></a>
		</span>
...
<div class="form-group">
 ...
 <div>
      ...
      <img src="images/profil/<?php if($data['foto'] == null){ echo 'default-image.jpg'; } else{echo $data['foto'];}  ?>" style="width: 120px;float: left;margin-bottom: 5px;"><br>
          <br><br><br><br><br><p><?php if($data['foto'] == null){ echo 'default-image.jpg'; } else{echo $data['foto'];}  ?></p>
